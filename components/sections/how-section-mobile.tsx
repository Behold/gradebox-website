...
const HowSectionMobile = () => {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      // Calculate dynamic offscreen positioning (adapted from desktop)
      const cardWidth = 300; // max-w-[400px]
      const offscreenOffset = (window.innerWidth - cardWidth) / cardWidth * 100 + 20;

      // Set initial states with dynamic positioning (same as desktop)
      ...
      // Handle resize for dynamic positioning (same as desktop)
      const handleResize = () => {
      ...
      // Create timeline (same structure as desktop)
      ...
      // Card animations (same as desktop)
      tl.addLabel("card1");
    ...
    <div ref={sectionRef} className="min-h-screen bg-transparent lg:hidden">
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="flex flex-col">
          <div ref={howContentRef} className="px-4 py-8 text-center">
          ...
          <div 
            className="relative flex justify-center items-center min-h-[60vh] w-full px-6 mt-32" 
            ref={cardsRef}
          >
            {/* Mobile cards - full width minus padding */}
            <div 
